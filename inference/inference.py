...
def main(input_path, model_path, output_dir, need_animation=True, resize_h=None, resize_w=None, serial=True):
    ...
    with torch.no_grad():
        ...
        # # 生成输出文件名
        # output_filename = f'{input_name}_{total_strokes}.jpg'
...
if __name__ == '__main__':
    main(input_path='input/chicago.jpg',
         model_path='../tta_copy3/checkpoints/painter/model_chicago_updated.pth',
        #  model_path='history/latest_net_g_1.pth',
