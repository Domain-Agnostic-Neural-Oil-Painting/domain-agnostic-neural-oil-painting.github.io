...
def main(input_path, model_path, output_dir, need_animation=False, resize_h=None, resize_w=None, serial=True):
    ...
    with torch.no_grad():
        ...
        for layer in range(0, K + 1):
            ...
            # 统计当前层画笔数
            total_strokes += decision.sum().item()
        ...
        # print("img_patch 变换后的形状：", img_patch.shape)
        # print("result_patch 变换后的形状：", result_patch.shape)
        shape_param, stroke_decision = net_g(img_patch, result_patch)
        ...
        # 生成输出文件名
        output_filename = f'{os.path.splitext(image_file)[0]}_{total_strokes}.jpg'
...
if __name__ == '__main__':
    input_dir = '../dataset/original/test_1024'
    model_dir = '../dataset/new/test'
    # model_path = '../dataset/new/test/model.pth'
    output_dir = '../dataset/test2_1024'
    ...
    for image_file in image_files:
        ...
        model_filename = f'model_{os.path.splitext(image_file)[0]}_updated.pth'
